...
public class OtherMenu extends Box {
    ...
    public void addElements() {
        ...
        addChild(new MultiChoice(1,2, LanguageManager.get("settings.other_settings.woke_mode"), new String[] {LanguageManager.get("settings.other_settings.woke_mode.none"), LanguageManager.get("settings.other_settings.woke_mode.gay"), LanguageManager.get("settings.other_settings.woke_mode.trans")}, 0));
